...
//   const [contactNo, setContactNo] = useState('');  // Contact Number
...
//     try {
//       // Pass all necessary fields to registerUser
...
//       if (onLogin) onLogin(true);  // Proceed to the app if onLogin is provided
